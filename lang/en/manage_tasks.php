...
return [
    'manage_tasks' => [
        ...
        'import_title' => 'Import',
        'import_desc'  => 'Upload a CSV file in Nexus or Clockify format (Reports → Detailed → Export CSV). Entries with the same start time for the same task are automatically skipped to prevent duplicates.',
        ...
        'cleanup_dupes_title'      => 'Duplicate entries',
        'cleanup_dupes_desc'       => 'Detects time entries with the same start time for the same task, generated by repeated imports.',
        'cleanup_dupes_btn_detect' => 'Detect duplicates',
        'cleanup_dupes_btn_fix'    => 'Delete duplicates',
        'cleanup_dupes_none'       => 'No duplicates found.',
        'cleanup_dupes_found'      => '{n} duplicate entries found.',
        'cleanup_dupes_confirm'    => 'Delete {n} duplicate entries? The oldest entry in each group will be kept.',
        'cleanup_dupes_success'    => '{n} duplicate entries deleted.',
