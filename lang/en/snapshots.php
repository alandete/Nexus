...
File: {file}',
        ...
        'field_sched_type'      => 'Backup type',
        'field_sched_freq'      => 'Frequency',
        'field_sched_hour'      => 'Time',
        'freq_daily'            => 'Daily',
        'freq_weekly'           => 'Weekly',
        'freq_monthly'          => 'Monthly',
        'cron_cmd_label'        => 'Cron command',
        'cron_cmd_help'         => 'Add this command in cPanel → Cron Jobs or Windows Task Scheduler.',
        'btn_copy_cron'         => 'Copy',
        'btn_regen_token'       => 'Regenerate token',
        'btn_save_schedule'     => 'Save',
        'schedule_last_run'     => 'Last automatic backup',
        'schedule_never'        => 'Never',
        'schedule_saved'        => 'Configuration saved.',
        'schedule_token_regenned' => 'Token regenerated. Update your cron with the new URL.',
        'schedule_err_save'     => 'Error saving configuration.',
        'schedule_err_regen'    => 'Error regenerating token.',
        'schedule_copied'       => 'Copied.',
        'btn_run_now'           => 'Run now',
        'btn_run_now_tip'       => 'Force an immediate backup to verify the cron works',
        'cron_run_ok'           => 'Backup executed: ',
        'cron_run_err'          => 'Error executing backup.',
        'cron_log_title'        => 'Recent runs',
        'cron_source_manual'    => 'Manual',
        'cron_source_auto'      => 'Cron',
    ],
];
