...
return [
    'tasks' => [
        ...
        'err_create'          => 'Could not create the task.',
        'view_detail'         => 'View detail',
        'no_description'      => 'No description',
        'no_due_date'         => 'No due date',
        'no_sessions_yet'     => 'No sessions yet',
        'no_entries_yet'      => 'No closed entries yet.',
        'entries_title'       => 'Entries',
        'entry_start'         => 'Start',
        'entry_end'           => 'End',
        'field_vencimiento'   => 'Due',
        'field_since'         => 'Since',
        'entry_updated'       => 'Entry updated.',
        'entry_deleted'       => 'Entry deleted.',
        'entry_err_required'  => 'Fill in both start and end time.',
        'entry_err_order'     => 'End time must be after start time.',
        'entry_err_overlap'   => 'Overlaps with another entry that day ({task}, {start}-{end})',
        'entry_err_update'    => 'Could not update the entry.',
        'entry_err_delete'    => 'Could not delete the entry.',
        'entry_delete_title'   => 'Delete entry',
        'entry_delete_message' => 'This time entry will be deleted and the task total will be recalculated. This cannot be undone.',
        'tags_select_placeholder' => 'Select tags...',
        'field_total_time'        => 'Total time',
        'field_status'            => 'Status',
        'status_delivered_ontime' => 'Delivered on time',
        'status_delivered_late'   => '{n} days late',
        'status_on_schedule'      => 'On schedule',
        'status_overdue_days'     => 'Overdue by {n} days',
        ...
        'history_page_info'      => 'Page {page} of {pages}',
        'pagination_prev'        => 'Previous',
        'pagination_next'        => 'Next',
        'empty_today_title'      => 'No activity today yet',
        'empty_today_desc'       => 'Tasks you complete or pause today will appear here.',
