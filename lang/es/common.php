...
return [
    ...
    'dashboard' => [
        ...
        // Timer activo
        'active_timer'       => 'Cronómetro activo',
        'no_active_timer'    => 'Sin cronómetro activo',
    ...
    // Settings overview
    'settings_overview' => [
        'subtitle'          => 'Configuración del sistema, gestión y monitoreo.',
        'users_desc'        => 'Cuentas, roles, permisos y sesiones.',
        'alliances_desc'    => 'Instituciones aliadas, responsables y archivos.',
        'manage_tasks_desc' => 'Administrar etiquetas, importar y exportar tareas, y limpieza de datos.',
    ...
    'settings' => [
        ...
        'apis_title'        => 'Configuración de APIs externas',
        ...
        'apis_ilp_desc'     => 'Plataforma compartida de iLovePDF e iLoveIMG. Las mismas claves habilitan el método API en Optimizar PDF y en Optimizar imágenes.',
        ...
        'apis_status_incomplete'   => 'Configuración incompleta',
        ...
        'deps_desc'           => 'Estado de los componentes externos requeridos por el optimizador de PDF e imágenes.',
        'deps_col_component'  => 'Componente',
        'deps_col_status'     => 'Estado',
        'deps_col_version'    => 'Versión',
        ...
        'deps_update_ok'      => 'Al día',
        'deps_last_check'     => 'Última verificacion',
        'deps_script_title'   => 'Instalador automático',
        ...
        'apis_guide_ilp_step2'  => 'Crea una cuenta gratuita con tu correo o inicia sesión si ya tienes una.',
        ...
        'apis_guide_ilp_step6'  => 'Haz clic en "Guardar claves" y luego en "Probar conexión" para confirmar que todo funciona.',
    ...
    'errors' => [
        ...
        '404_description' => 'La página que buscas no existe o fue movida.',
        '403_title'       => 'Acceso denegado',
        '403_description' => 'No tienes permisos para acceder a esta sección.',
