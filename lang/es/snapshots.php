...
Archivo: {file}',
        ...
        'btn_run_now_tip'       => 'Fuerza un backup inmediato para probar que el cron funciona',
        'cron_run_ok'           => 'Backup ejecutado: ',
        'cron_run_err'          => 'Error al ejecutar el backup.',
        'cron_log_title'        => 'Últimas ejecuciones',
