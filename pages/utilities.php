<?php
/**
 * Nexus 2.0 — Utilidades
 * Convertir preguntas · Optimizar PDF · Optimizar Imágenes
 */
...
<div class="page-header">
    <div>
        <h1 class="page-title"><?= __('utilities.page_title') ?></h1>
    </div>
</div>

<!-- Barra de tabs principal -->
<nav class="utils-tab-bar" aria-label="<?= __('utilities.page_title') ?>">
    <a href="#preguntas" class="utils-tab" data-utab="preguntas">
        <i class="bi bi-file-earmark-text" aria-hidden="true"></i>
        <span><?= __('utilities.tab_gift') ?></span>
    </a>
    <a href="#pdf" class="utils-tab" data-utab="pdf">
        <i class="bi bi-file-earmark-pdf" aria-hidden="true"></i>
        <span><?= __('utilities.tab_pdf_optimizer') ?></span>
    </a>
    <a href="#imagenes" class="utils-tab" data-utab="imagenes">
        <i class="bi bi-image" aria-hidden="true"></i>
        <span><?= __('utilities.tab_image_optimizer') ?></span>
    </a>
</nav>

<!-- ═══════════════════════════════════════════════════════════════════════════
     Sección: Convertir preguntas
     ═══════════════════════════════════════════════════════════════════════════ -->
<section id="preguntas" class="utils-section" hidden>
    <div class="card">
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     Sección: Optimizar PDF
     ═══════════════════════════════════════════════════════════════════════════ -->
<section id="pdf" class="utils-section" hidden>
    <div class="card">
        <div class="card-body empty-state p-400">
...
<!-- ═══════════════════════════════════════════════════════════════════════════
     Sección: Optimizar Imágenes
     ═══════════════════════════════════════════════════════════════════════════ -->
<section id="imagenes" class="utils-section">
